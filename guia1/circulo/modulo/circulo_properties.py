# -*- coding: utf-8 -*-
"""
Created on Thu Aug 11 11:06:26 2022
...
class Circulo:
    ...
    radio = property(fget = get_radio, fset = set_radio, doc = "propiedad radio del ciruclo" )
    area = property(fget = get_area, doc = "propiedad area del circulo")
